                ...
                do
                {
                    ...
                    switch(choice3)
                    {
                        case '1':
                                ...
                                equipped_weapon = weapon[0].getName();
                                equipped_attack = weapon[0].getAttack();
                                strength = 5;
                                gold = 30;
                                magicstat = 3;
                                break;
...
void Hero::save()
{
    ...
    for(i=0; i<9; i++)
        item[i].save(ofs);
        // ofs << item[i].getType() << " " << item[i].getName() << " " << item[i].getPrice() << " " << item[i].getSellPrice() << " " << item[i].getHealing() << "\n";
    ...
    do {cout << "\n (1) Items \n (2) Weapons \n (3) Armor \n (4) Spells \n (0) Exit" << endl;
        ...
        switch(choice)
        {
            ...
            case 1:
                    ...
                    for(i=0; i<9; i++)
                        if(item[i].getName() != "none") item[i].print();
                    break;
            case 2:
            ...
            do
            {
                ...
                switch(choice)
                {
                    case '1':
                        ...
                        for(i=0; i<5; i++)
                            if(equipped_weapon == weapon[i].getName()) weapon[i].setProficiency(equipped_proficiency);
                        print();
                        break;
                    case '2':
                        break;
                ...
                switch(choice)
                {
                    ...
                    case 1:
                        ...
                        do
                        {
                            for(i=0; i<3; i++)
                            {
                                if(answer2 == armor[i].getName())
                                {
                                    choice2 = 0;
                                    break;
                                }
                                else if(answer2 != armor[i].getName()) choice2 = 1;
                            }
                            if(choice2 == 1)
                            {
                    ...
                    case 2:
                        ...
                        for(i=0; i<3; i++)
                        {
                            if(weapon[i].getName() != "none") cout << setw(11) << weapon[i].getName() << setw(4) << weapon[i].getAttack() << " attack" << setw(3) << weapon[i].getProfLevel() << " proficiency" << endl;
                        }
                        cin >> answer2;
                        do
                        {
                            for(i=0; i<3; i++)
                            {
                                if(answer2 == weapon[i].getName())
                                {
                                    choice2 = 0;
                                    break;
                                }
                                else if(answer2 != weapon[i].getName()) choice2 = 1;
                            }
                            if(choice2 == 1)
                            {
                        ...
                        for(i=0; i<3; i++)
                        {
                            if(weapon[i].getName() == answer2)
                            {
                                equipped_weapon = weapon[i].getName();
                                equipped_attack = weapon[i].getAttack();
                                equipped_proficiency = weapon[i].getProficiency();
                            }
                        }
...
{
    double temp_level, temp_prof_level, prof_difference, difference = 0, temp_const, const_diff, temp_magic, magic_diff, temp_damage[5];
    int choice, i;
    ...
    for(i=0; i<5; i++)
    {
        weapon[i].setProfLevel(weapon[i].getProficiency() / 130);
        if(equipped_weapon == weapon[i].getName())
        {
            equipped_prof_level = weapon[i].getProfLevel();
            equipped_proficiency = weapon[i].getProficiency();
        }
    }
    ...
    for(i=0; i<5; i++)
    {
        if(weapon[i].getName() != "none" && level/2 == (level+1)/2 && difference >= 1) weapon[i].setAttack(weapon[i].getAttack() + difference);
        if(equipped_weapon == weapon[i].getName())
        {
            equipped_attack = strength + weapon[i].getAttack();
            weapon[i].setProficiency(equipped_proficiency);
            weapon[i].setProfLevel(equipped_prof_level);
        }
    }
    equipped_attack += prof_difference;
    for(i=0; i<5; i++)
        if(equipped_weapon == weapon[i].getName()) weapon[i].setAttack(equipped_attack - strength);
        ...
        do
        {
            ...
            switch(choice)
            {
                ...
                case 2:
                        ...
                        for(i=0; i<5; i++)
                            if(weapon[i].getName() != "none") cout << " " << weapon[i].getName() << " " << weapon[i].getSellPrice() << " gold" << endl;
                        cout << "\nWhich do you want to sell?" << endl;
                        cin >> answer;
                        for(i=0; i<5; i++)
                            if(weapon[i].getName() == answer && answer != "none")
                            {
                                item_check = "true";
                                break;
                            }
                        ...
                        {
                            gold += weapon[i].getSellPrice();
                            cout << "You have sold your " << weapon[i].getName() << " for " << weapon[i].getSellPrice() << " gold." << endl;
        ...
        do
        {
            ...
            switch(choice)
            {
                ...
                case 1:
                        ...
                        switch(choice2)
                        {
                            ...
                            case 2:
                                    ...
                                    {
                                        for(i=0; i<5; i++)
                                            if(armor[i].getName() == "hard_leather")
                                            {
                                                item_check = "false";
                                                break;
                                            }
                ...
                case 2:
                        ...
                        for(i=0; i<5; i++)
                            if(armor[i].getName() != "none") cout << " " << armor[i].getName() << " " << armor[i].getSellPrice() << " gold" << endl;
                        cout << "\nWhich do you want to sell?" << endl;
                        cin >> answer;
                        for(i=0; i<5; i++)
                            if(armor[i].getName() == answer && answer != "none")
                            {
                                item_check = "true";
                                break;
                            }
                        ...
                        {
                            gold += armor[i].getSellPrice();
                            cout << "You have sold your " << armor[i].getName() << " for " << armor[i].getSellPrice() << " gold." << endl;
                            armor[i].destroy();
                            break;
                        }
    ...
    do
    {
        ...
        switch(choice)
        {
                            ...
                            case 1:
                                    ...
                                    if(answer == "yes" || answer == "Yes")
                                    {
                                        if(gold >= 10)
                                        {
                                            ...
                                            if(item_check == "true")
                                            {
                                                item[i].create("food", "food", 10, 10);
                                                gold -= item[i].getPrice();
                                                break;
                                            }
                                        ...
                                        case 2:
                                                ...
                                                if(answer == "yes" || answer == "Yes")
                                                {
                                                    if(gold >= 35)
                                                    {
                                                        ...
                                                        if(item_check == "true")
                                                        {
                                                            item[i].create("emerald", "gem", 0, 35);
                                                            gold -= item[i].getPrice();
                                        ...
                                        case 3:
                                                ...
                                                if(answer == "yes" || answer == "Yes")
                                                {
                                                    if(gold >= 35)
                                                    {
                                                        ...
                                                        if(item_check == "true")
                                                            {
                                                                item[i].create("sapphire", "gem", 0, 35);
                                                                gold -= item[i].getPrice();
                                        ...
                                        case 4:
                                                ...
                                                if(answer == "yes" || answer == "Yes")
                                                {
                                                    if(gold >= 45)
                                                    {
                                                        ...
                                                        if(item_check == "true")
                                                            {
                                                                item[i].create("diamond", "gem", 0, 45);
                                                                gold -= item[i].getPrice();
            ...
            case 2:
                    ...
                    for(i=0; i<9; i++)
                        if(item[i].getName() != "none") cout << setw(14) << item[i].getName() << "  " << item[i].getSellPrice() << " gold" << endl;
                    cout << "\nWhich do you want to sell?" << endl;
                    cin >> answer;
                    for(i=0; i<9; i++)
                        if(item[i].getName() == answer && answer != "none")
                        {
                            item_check = "true";
                            break;
                        }
                    ...
                    if(item_check == "true")
                    {
                        cout << "You have sold your " << item[i].getName() << " for " << item[i].getSellPrice() << " gold." << endl;
                        gold += item[i].getSellPrice();
                        item[i].destroy();
                        break;
                    }
    ...
    do
    {
        ...
        switch(choice)
        {
            case 1:
                    ...
                    for(i=0; i<5; i++)
                        if(weapon[i].getName() != "none") cout << " " << weapon[i].getName() << "  " << weapon[i].getAttack() << " attack" << endl;
                    cin >> answer;
                    for(i=0; i<5; i++)
                        if(answer == weapon[i].getName())
                        {
                            item_check = "true";
                            break;
                        }
                    ...
                    if(item_check == "true")
                    {
                        ...
                        for(j=0; j<9; j++)
                            if(item[j].getName() != "food" && item[j].getName() != "none") cout << " " << item[j].getName() << endl;
                        cin >> answer;
                        for(j=0; j<9; j++)
                            if(answer == item[j].getName() && answer != "none")
                            {
                                item_check = "true";
                                break;
                            }
                        ...
                        if(item_check == "true")
                        {
                            if(item[j].getName() == "ruby")
                            {
                                weapon[i].incAttack(2);
                                item[j].destroy();
                                cout << "You have added a ruby to your " << weapon[i].getName() << "." << endl;
                                for(i=0; i<5; i++)
                                    if(weapon[i].getName() == equipped_weapon) equipped_attack = strength + weapon[i].getAttack();
                                statupdate();
                            }
                            else if(item[j].getName() == "emerald")
                            {
                                weapon[i].incAttack(3);
                                item[j].destroy();
                                cout << "You have added an emerald to your " << weapon[i].getName() << "." << endl;
                                for(i=0; i<5; i++)
                                    if(weapon[i].getName() == equipped_weapon) equipped_attack = strength + weapon[i].getAttack();
                                statupdate();
                            }
                            else if(item[j].getName() == "sapphire")
                            {
                                weapon[i].incAttack(4);
                                item[j].destroy();
                                cout << "You have added a sapphire to your " << weapon[i].getName() << "." << endl;
                                for(i=0; i<5; i++)
                                    if(weapon[i].getName() == equipped_weapon) equipped_attack = strength + weapon[i].getAttack();
                                statupdate();
                            }
                            else if(item[j].getName() == "diamond")
                            {
                                weapon[i].incAttack(5);
                                item[j].destroy();
                                cout << "You have added a diamond to your " << weapon[i].getName() << "." << endl;
                                for(i=0; i<5; i++)
                                    if(weapon[i].getName() == equipped_weapon) equipped_attack = strength + weapon[i].getAttack();
                                statupdate();
                            }
            ...
            case 2:
                    ...
                    for(i=0; i<5; i++)
                        if(weapon[i].getName() != "none") cout << weapon[i].getName() << "  " << weapon[i].getProfLevel() << " proficiency" << endl;
                    cin >> answer;
                    for(i=0; i<5; i++)
                        if(answer == weapon[i].getName() && answer != "none")
                        {
                            item_check = "true";
                            break;
                        }
                    ...
                    if(item_check == "true")
                    {
                        cout << "We can add 1 proficiency level for 150 gold to your " << weapon[i].getName() << ". Would you like to do it?" << endl;
                        cin >> answer;
                        if(answer == "yes" || answer == "Yes" || answer == "YES")
                        {
                            if(gold >= 150)
                            {
                                weapon[i].incProficiency(130);
                                gold -= 150;
                                cout << "You have added 1 proficiency level to your " << weapon[i].getName() << "." << endl;
                                for(i=0; i<5; i++)
                                    if(weapon[i].getName() == equipped_weapon) equipped_proficiency = weapon[i].getProficiency();
                                statupdate();
                            }
                            else cout << "You don't have enough gold!" << endl;
                        }
        ...
        switch(choice)
        {
            ...
            case 4:
                    ...
                    for(i=0; i<9; i++)
                    {
                        ...
                        if(item[i].getName() != "none") cout << item[i].getName() << "  " << item[i].getHealing() << " healing power" << endl;
        ...
        if(enemy.health <= 0)
                {
                 ...
                 for(i=0; i<5; i++)
                    if(weapon[i].getName() == equipped_weapon) weapon[i].setProficiency(equipped_proficiency);
        ...
        if(random_orc == 1)
        {
            ...
            if(train("orc", "wild"))
            {
                ...
                if(item_check == "true")
                {
                    ...
                    if(item_drop == 0)
                    {
                        item[i].create("rusty_dagger", "item", 0, 6);
...
{
    Hero player2;
    int player2temp_attack, player2temp_proficiency, player2temp_experience, player2temp_gold, player2temp_magic_xp = 0, player2turn = 0;
        ...
        switch(choice2)
        {
            case 2:
                    ...
                    if(answer == "yes" || answer == "Yes")
                    {
                        ...
                        for(i=0; i<5; i++)
                            if(player2.equipped_weapon == player2.weapon[i].getName()) player2.weapon[i].setProficiency(player2.equipped_proficiency);
                    }
                    break;
            case 3:
                    ...
                    for(i=0; i<9; i++)
                    {
                        ...
                        if(player2.item[i].getName() != "none") cout << player2.item[i].getName() << "  " << player2.item[i].getHealing() << " healing power" << endl;
                    ...
                    if(answer == "food")
                    {
                        for(i=0; i<9; i++)
                        {
                            if(player2.item[i].getName() == "food")
                            {
                                item_check = "true";
                                break;
                            }
                        ...
                        if(item_check == "true")
                        {
                            player2.health += player2.item[i].getHealing();
                    ...
                    else if(answer == "roast")
                    {
                        for(i=0; i<9; i++)
                        {
                            if(player2.item[i].getName() == "roast")
                            {
                                item_check = "true";
                                break;
                            }
                    ...
                    else if(answer == "chicken")
                    {
                        for(i=0; i<9; i++)
                        {
                            if(player2.item[i].getName() == "chicken")
                            {
                                item_check = "true";
                                break;
                            }
    ...
    if(health <= 0)
    {
        ...
        for(i=0; i<3; i++)
        if(player2.weapon[i].getName() == player2.equipped_weapon) player2.weapon[i].setProficiency(player2.equipped_proficiency);
    }
    ...
    if(location == "city")
    {
        ...
        if(city[x][y] == '&' || city[x][y] == '$')
        {
            ...
            if(item_check == "false")
            {
                ...
                for(i=0; i<9; i++)
                    if(item[i].getName() == "space") item[i].getName() = "none";
            }
            if(item_check == "true")
            {
                for(i=0; i<9; i++)
                    if(item[i].getName() == "space")
                    {
                        item[i].create("ruby", "gem", 0, 35);
                        break;
                    }
                ...
                for(i=0; i<9; i++)
                    if(item[i].getName() == "space")
                    {
                        item[i].create("jeweled_sword", "item", 0, 40);
                        break;
                    }
            }
        }
